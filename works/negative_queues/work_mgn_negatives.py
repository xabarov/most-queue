...
if __name__ == "__main__":
    ...
    results_utilization = run_depends_on_utilization(base_qp, queue_discipline)
    ...
    for results, save_path, xs, depends_on in zip(
        [results_channels, results_coefs, results_utilization],
        [SAVE_PATH_CHANNELS, SAVE_PATH_COEFS, SAVE_PATH_UTILIZATION_FACTOR],
        [xs_channels, xs_coefs, xs_utilization],
        [
        ...
        plot_params = [
            {
                "sim_results": v_sim_ave,
                "calc_results": v_calc_ave,
                "save_path": os.path.join(save_path, "v_ave.png"),
                "is_errors": False,
                "is_waiting_time": False,
            },
            {
                "sim_results": w_sim_ave,
                "calc_results": w_calc_ave,
                "save_path": os.path.join(save_path, "w_ave.png"),
                "is_errors": False,
                "is_waiting_time": True,
            },
            {
                "sim_results": v_sim_broken_ave,
                "calc_results": v_calc_broken_ave,
                "save_path": os.path.join(save_path, "v_broken_ave.png"),
                "is_errors": False,
                "is_waiting_time": False,
            },
            {
                "sim_results": v_sim_served_ave,
                "calc_results": v_calc_served_ave,
