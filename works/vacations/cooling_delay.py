...
def run_cool_delay_cv(qp, save_path: str = None):
    """
    ...
    if save_path:
        wait_time_save_path = os.path.join(save_path, "w1_vs_cool_delay_cv.png")

        plot_w1(cool_cvs, w1_num, w1_sim, x_label="Cooling Delay CV", save_path=wait_time_save_path)
