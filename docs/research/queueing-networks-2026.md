...
2026-07-13). Пункты 6–8 и перенесённый из эпика резерв (RQNA-поправки, мультикласс
сигналов G-сетей, mixed BCMP, многоканальные станции в мультичейн-MVA) оформлены как
[EPIC-018](../epics/EPIC-018-networks-wave2.md) вместе с MAP-входом сети, схемами
каталога и туториалами по сетям.
