...
2026-07-13). Пункты 6–7, MAP-вход, transient-сети (п. 8 частично), мультикласс G-сетей,
многоканальный мультичейн-MVA, схемы каталога и туториалы — в
[EPIC-018](../epics/EPIC-018-networks-wave2.md) (done, 2026-07-13). В резерве остаются:
RQNA-поправки, mixed BCMP, LQN (п. 2.6), RL-управление и нейроаппроксиматоры (п. 2.8).
