...
1. Изучите [основные концепции](concepts.ru.md) теории массового обслуживания
2. Ознакомьтесь с [руководством по симуляции](simulation.ru.md)
3. Изучите [численные методы](calculation.ru.md)
4. Посмотрите [примеры использования](examples.ru.md)
