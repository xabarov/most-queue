...
![Схема M/M/c](figures/fifo_mmn.png)
...
![Система с потерями Erlang B](figures/loss.png)
...
![Сравнение дисциплин FCFS/SJF/SRPT](figures/disciplines_timeline.png)
...
![Замедление по размерам заявки для FCFS/PS/FB/SRPT](figures/slowdown.png)
...
![Схема Processor Sharing](figures/ps.png)
...
![Схема LCFS-PR](figures/lcfs_pr.png)
...
![Схема приоритетного обслуживания](figures/priority.png)
...
![Жизненный цикл прибора в vacation-моделях](figures/vacations.png)
...
![Схема N-policy](figures/n_policy.png)
...
![Схема ненадёжного прибора](figures/unreliable.png)
...
![Отрицательные заявки: RCS и disaster](figures/negative.png)
...
![Схема Fork-Join](figures/fork_join.png)
...
![Схема пакетного поступления](figures/batch.png)
...
![Схема нетерпеливых заявок](figures/impatience.png)
