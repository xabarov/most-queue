...
- [x] **Баг BatchMM1.get_w1** (исправлен 2026-07-09): среднее ожидание делилось на λ/μ
      вместо интенсивности потока заявок (mean_batch·λ) — завышение ~7× и противоречие
      собственному E[V]. Вскрыт кросс-валидацией с BMAP/M/1; исправлено (E[W]=E[V]−1/μ).
