...
![Знакомые распределения как фазовые цепочки](figures/ph_gallery.png)
...
[калькулятор MAP/PH/1](models.ru.md) принимает любое PH, так что одна модель покрывает всё —
...
![Механика MMPP](figures/mmpp.png)
