...
Теоретические формулы для SRPT/SJF/PSJF/SPJF, схема численного интегрирования в калькуляторах и типичная процедура сравнения с симуляцией описаны на странице **[SRPT / SPJF: методы и верификация](srpt_spjf_methods.md)**.
