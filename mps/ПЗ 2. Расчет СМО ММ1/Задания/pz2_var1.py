...
def get_w_teor(mu, l):
    """
     Функция расчета среднего времени ожидания в СМО М/M/1
...
if __name__=="__main__":
    ...
    for i, ro in enumerate(roes):
        ...
        # errors.append(100*(w1_teor-w1_im)/w1_teor)
    ...
    #     print(str_f.format(roes[i], w1_im_mass[i], w1_teor_mass[i], errors[i]))
    # print("-"*62)
