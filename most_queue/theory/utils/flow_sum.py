"""
Class for numerical summation of flows.
"""
...
class SummatorNumeric:
    ...
    def sum_flows(self):
        ...
        for flow in self.flows_:
            self.a1_sum.append(flow[0])
            self.a2_sum.append(flow[1])
    ...
    def sum_2_flows_semiinvariants(a1, a2):
        """
        Sum semiinvariants of two flows
        """
    ...
    def get_error(test, real):
        """
        Calculate error between test and real values.
        """
