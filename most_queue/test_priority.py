...
from theory.mgn_with_h2_delay_cold_warm import MGnH2ServingColdWarmDelay

from utils.vacations_paper_utils import dump_stat
from utils.vacations_paper_utils import print_table, make_plot, calc_moments_by_mean_and_coev, load_stat
...
def test_all():
    ...
    if not os.path.exists(delay_json_filename):
        ...
        delay_stat = run_delay_mean(b1_service=10.0, coev_service=1.2,
                                     ...
                                     w_pls_dt=1e-3, stable_w_pls=True, sim_ave=3)
