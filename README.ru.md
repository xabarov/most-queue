...
- 🗺 [Планы развития](docs/epics/README.md) и [обзор трендов](docs/research/queueing-trends-2026.md) — что дальше (балансировка нагрузки / power-of-d, queueing-inventory, закрытые сети / MVA, polling)
