...
| Сети | открытые (декомпозиция, точный Джексон, QNA с двухмоментными потоками), закрытые (точный MVA / свёртка Бьюзена / Швейцер), мультиклассовые BCMP, G-сети (Геленбе), приоритеты, отрицательные заявки, оптимизация маршрутизации | декомпозиция / product form / MVA |
