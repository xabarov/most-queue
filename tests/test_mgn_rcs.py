...
def test_mgn():
    ...
    times_print(sim_results.v, calc_results.v, is_w=False, header="Total sojourn time")
    times_print(sim_results.v_served, calc_results.v_served, is_w=False, header="Served sojourn time")
    times_print(sim_results.v_broken, calc_results.v_broken, is_w=False, header="Broken sojourn time")
