...
def test_mgn():
    ...
    times_print(v_sim, calc_results.v, is_w=False, header="Total sojourn time")
    times_print(v_sim_served, calc_results.v_served, is_w=False, header="Served sojourn time")
    times_print(v_sim_broken, calc_results.v_broken, is_w=False, header="Broken sojourn time")
