...
def test_mmn_prty():
    ...
    times_print(
        sim_moments=sim_results.v[0], calc_moments=calc_results.v[0], is_w=False, header="soujorn time for 1 class"
    )
    times_print(
        sim_moments=sim_results.w[0], calc_moments=calc_results.w[0], is_w=True, header="waiting time for 1 class"
    )
    times_print(
